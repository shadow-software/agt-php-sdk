...
class DealerAccountApi
{
    ...
    {
        list($response) = $this->dealerApiMeWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation dealerApiMeWithHttpInfo
     *
     * The dealer&#39;s identity and, crucially, whether they can publish right now
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiMe'] to see the possible values for this operation
     ...
     */
    public function dealerApiMeAsync(string $contentType = self::contentTypes['dealerApiMe'][0])
    {
        return $this->dealerApiMeAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dealerApiMeAsyncWithHttpInfo
     *
     * The dealer&#39;s identity and, crucially, whether they can publish right now
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiMe'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'dealerApiMe'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiMe'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function dealerApiMeRequest(string $contentType = self::contentTypes['dealerApiMe'][0])
    {
    ...
    {
        list($response) = $this->dealerApiTaxonomyWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation dealerApiTaxonomyWithHttpInfo
     *
     * Everything the plugin needs to build a valid listing: the category tree, the manufacturers, the calibers, the applications, and the conditions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiTaxonomy'] to see the possible values for this operation
    ...
    /**
     * Operation dealerApiTaxonomyAsync
     *
     * Everything the plugin needs to build a valid listing: the category tree, the manufacturers, the calibers, the applications, and the conditions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiTaxonomy'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dealerApiTaxonomyAsync(string $contentType = self::contentTypes['dealerApiTaxonomy'][0])
    {
        return $this->dealerApiTaxonomyAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation dealerApiTaxonomyAsyncWithHttpInfo
     *
     * Everything the plugin needs to build a valid listing: the category tree, the manufacturers, the calibers, the applications, and the conditions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiTaxonomy'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'dealerApiTaxonomy'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['dealerApiTaxonomy'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function dealerApiTaxonomyRequest(string $contentType = self::contentTypes['dealerApiTaxonomy'][0])
    {


        $resourcePath = '/taxonomy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
