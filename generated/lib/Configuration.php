...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost:8080/api/v1/dealer';
    ...
    {
        $report  = 'PHP SDK (ShadowSoftware\Agt) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "http://localhost:8080/api/v1/dealer",
